...
(function (global) {
  ...
  function save() {
    ...
    try {
      localStorage.setItem(storageKey(), JSON.stringify({
        ...
        manipulations: state.manipulations
      }));
  ...
  function buildCode() {
    ...
    // Format (v2+):  MODULEvVER - NAMETOKEN - ADJ - ANIMAL - SCAFFOLDBITS - MANIPULATIONS
    // Legacy (v1):   MODULEvVER - NAMETOKEN - ADJ - ANIMAL - PREBITS - SCAFFOLDBITS - POSTBITS
    // Manipulations token is alphabetically-sorted "A12B8C5" with one section
    // per stage label the lesson called Score.bumpManipulation on.
